...
public sealed class WorkItemServiceTests
{
    ...
    public async Task ListAsync_Filters_By_ProjectId()
    {
        ...
        _workItems.Seed(
            new WorkItem(projectId: _existingProjectId, title: "Keep me", source: SourceLabel.Ergonaut),
            new WorkItem(projectId: otherProjectId, title: "Ignore me", source: SourceLabel.Ergonaut));
    ...
    {
        var workItem = new WorkItem(projectId: _existingProjectId, title: "Delete me", source: SourceLabel.Ergonaut);
